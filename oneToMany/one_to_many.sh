...
do
  ...
  do
    ...
    #  cat $FN
     docker run -v $(PWD):/gen/ -m 4GB --entrypoint "./scribblec.sh" scribble-java -d ./scribblec.sh -d /gen/src /gen/Large.scr -api-ps OneToMany > /dev/null 2>&1
     mv src/Scribble/Protocol/Large/*.purs OneToMany$i.purs
