...
instance acceptS13 :: Accept A B15 S13 S14
instance receiveS14 :: Receive B15 S14 S15 M
instance disconnectS15 :: Disconnect A B2 S15 S16
instance disconnectS16 :: Disconnect A B15 S16 S11

foreign import data B15 :: Role

instance roleNameB15 :: RoleName B15 "B15"

foreign import data S180 :: Type
foreign import data S182 :: Type
foreign import data S183 :: Type
foreign import data S183Connected :: Type
foreign import data S184 :: Type
foreign import data S185 :: Type
foreign import data S186 :: Type
foreign import data S181 :: Type

instance initialB15 :: Initial B15 S180
instance terminalB15 :: Terminal B15 S181
instance acceptS180 :: Accept B15 B14 S180 S182
instance receiveS182 :: Receive B14 S182 S183 M
instance connectS183 :: Connect B15 A S183 S183Connected
instance sendS183 :: Send A S183Connected S184 Connect
instance sendS184 :: Send A S184 S185 M
instance disconnectS185 :: Disconnect B15 B14 S185 S186
instance disconnectS186 :: Disconnect B15 A S186 S181

foreign import data B14 :: Role

instance roleNameB14 :: RoleName B14 "B14"

foreign import data S170 :: Type
foreign import data S172 :: Type
foreign import data S173 :: Type
foreign import data S173Connected :: Type
foreign import data S174 :: Type
foreign import data S175 :: Type
foreign import data S176 :: Type
foreign import data S171 :: Type

instance initialB14 :: Initial B14 S170
instance terminalB14 :: Terminal B14 S171
instance acceptS170 :: Accept B14 B13 S170 S172
instance receiveS172 :: Receive B13 S172 S173 M
instance connectS173 :: Connect B14 B15 S173 S173Connected
instance sendS173 :: Send B15 S173Connected S174 Connect
instance sendS174 :: Send B15 S174 S175 M
instance disconnectS175 :: Disconnect B14 B13 S175 S176
instance disconnectS176 :: Disconnect B14 B15 S176 S171
...
instance connectS163 :: Connect B13 B14 S163 S163Connected
instance sendS163 :: Send B14 S163Connected S164 Connect
instance sendS164 :: Send B14 S164 S165 M
instance disconnectS165 :: Disconnect B13 B12 S165 S166
instance disconnectS166 :: Disconnect B13 B14 S166 S161
